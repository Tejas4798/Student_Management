...
public class Student {
	...
	public Student(int student_id, String student_Name, String student_address, long student_mobile) {
		super();
		this.student_id = student_id;
		this.student_Name = student_Name;
		this.student_address = student_address;
	...
	public Student(String student_Name, String student_address, long student_mobile) {
		super();
		this.student_Name = student_Name;
		this.student_address = student_address;
		this.student_mobile = student_mobile;
